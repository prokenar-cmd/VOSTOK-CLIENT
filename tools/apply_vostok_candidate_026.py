...
s, count = pattern.subn(new_messages, s, count=1)
if count != 1:
...
# Guards: no donor brand or English connection status can survive in the paths above.
loc_text = loc.read_text()
main_text = main.read_text()
netrpc_text = netrpc.read_text()
