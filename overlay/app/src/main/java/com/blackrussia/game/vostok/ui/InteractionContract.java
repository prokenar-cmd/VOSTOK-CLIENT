...
public final class InteractionContract {
    ...
    // Radial menu purpose. Kept here so JNI/native code can pass primitive values later.
    public static final int RADIAL_TARGETS = 1;
    public static final int RADIAL_ACTIONS = 2;
    public static final int RADIAL_CONTEXT = 3;

    /**
     * Default resolution rule. It does not decide permissions or distance; it only chooses
     * presentation once authoritative candidates/actions have already been supplied.
     */
