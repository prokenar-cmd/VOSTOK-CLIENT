 ...
 *
 * This class contains no Android view code and no gameplay authority. Native/server code supplies
 * valid targets/actions; this core decides only direct-vs-radial presentation. Runtime policy
 * currently enables NPC targets only.
 */
public final class InteractionCore {
     ...
     * concrete NPC when the temporary /interact transport is sent.
     */
    ...
    /**
     * Future generic entry point for native/RPC-fed candidate sets. Disabled target kinds are
     * filtered here instead of being guessed by the UI.
     */
