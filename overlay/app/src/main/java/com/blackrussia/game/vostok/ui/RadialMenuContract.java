 ...
 *
 * No visual radial menu is enabled yet. This model is intentionally reusable by interaction,
 * jobs and future gameplay systems so they do not create incompatible radial implementations.
 */
